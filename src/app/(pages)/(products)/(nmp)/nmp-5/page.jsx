...
const TyentNMP7 = () => {
  ...
  const specifications = [
    ...
    { label: "Hydrogen Range", name: "Up to 1800PPB" },
    { label: "Generates", name: "7 types of water levels" },
    { label: "pH Levels", name: "3 Alkaline, 2 Acidic, 1 Neutral, 1 Turbo (Strong alkaline 11.5pH)" },
    { label: "Plate Surface Area", name: "52.9×11 = 581.9 sq inches" },
    { label: "Water Generating Capacity", name: "1.5 - 3.0L/min" },
    ...
    { label: "Filter Capacity", name: "8500L" },
    { label: "Dimensions", name: "300(W) * 135(D) * 355(H) mm" },
    { label: "Weight", name: "5.2kg" },
    ...
    { label: "Operating Voltage Range", name: "200 - 240V, 50-60HZ" },
    { label: "Voice Confirmation", name: "Yes" },
    { label: "Input Water Parameters", name: "Input water TDS: 90 - 160, Input water pH: 7PH, Input water Pressure: 5-7L/Min" },
    ...
    { label: "Safety Functions", name: "Water temperature sensor, Supplying water sensor, Overheating protection sensor & Error indication sensor" },
    ...
    { label: "Additional Chemicals", name: "No" },
