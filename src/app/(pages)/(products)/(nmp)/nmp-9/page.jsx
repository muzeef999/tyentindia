...
const selectedSpecifications = specifications.filter((item) =>
  ...
  return (
    ...
    <div className="d-flex gap-3 justify-content-center align-items-center">
        ...
        <Col md={6}>
          <h1 style={{fontWeight:600, color:'#008AC7'}}>Tyent NMP-9</h1>
          <hr/>
